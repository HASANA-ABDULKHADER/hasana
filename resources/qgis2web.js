...
map.getView().fit([8433151.677233, 1129050.133972, 8605113.816939, 1289388.684214], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BHARATAPUZHAWEB</h2>';
        return titleElement;
    })(),
